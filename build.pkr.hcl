build {
  sources = ["sources.vsphere-iso.ubuntu-ova-esx"]
  ...
  provisioner "ansible-local" {
    ...
    extra_arguments = [
      "--extra-vars",
      "\"bootstrap_user_ssh_public_key='${var.mystic_user_ssh_public_key}'\""
    ]
  }
...
build {
  sources = ["sources.vsphere-iso.ubuntu-vsphere-template"]
